...
var renderField = function renderField(fields) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_semanticUiReact.Form.Field, {
    ...
    animation: "fade",
    value: input.value && (input.value.from || input.value.to) ? "".concat(input.value.from ? (0, _moment["default"])(input.value.from).startOf('day').format(dateFormat) : '', " - ").concat(input.value.to ? (0, _moment["default"])(input.value.to).endOf('day').format(dateFormat) : '') : '',
