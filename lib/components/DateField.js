...
var renderField = function renderField(fields) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_semanticUiReact.Form.Field, {
    ...
    htmlFor: id
  }, label, /*#__PURE__*/_react["default"].createElement("small", null, touched && error ? "* ( ".concat(error, " )") : undefined)), /*#__PURE__*/_react["default"].createElement(_semanticUiCalendarReact.DateInput, _extends({}, rest, input, {
    ...
    value: _moment["default"].isMoment(input.value) ? input.value.format(dateFormat) : input.value
  })));
};
